...
public class GameController : MonoBehaviour
{
    ...
    public void GenerateQuestion()
    {
        ...
        if (option == 0)
        {
            ...
            option2.GetComponent<Option1>().isCorrect = false;
            option3.GetComponent<Option1>().isCorrect = false;
        ...
        else if(option==1)
        {
            ...
            option2.GetComponent<Option1>().isCorrect = true;
        ...
        else
        {
            ...
            option3.GetComponent<Option1>().isCorrect = true;
            option1.GetComponent<Option1>().isCorrect = false;
            option2.GetComponent<Option1>().isCorrect = false;
            // 分流三：第二個選項負責正確的答案、第一個選項負責錯誤的答案
        }
